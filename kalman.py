...
if __name__ == "__main__":
    ...
    sensors = [DummySensor(RS.vel_vect, 2, 0.5), IMU(RS), GPS(RS)]
    kf = KalmanFilter(sensors, tv, 0.1, dt)
    ...
    for sensor in sensors:
        axs[0].plot(RS.time_vector[0::sensor.freq], sensor.observation_in_time()[0::sensor.freq], "--", linewidth=0.3)
